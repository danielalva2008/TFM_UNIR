# -*- coding: utf-8 -*-
"""Modelo_de_Partidos_Politicos_RF.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Gm9g6Ov1QcIBsR0H6c68rCNNqu2i9-Hj
...
rf = RandomForestClassifier(labelCol="label", featuresCol="features")
rfr = OneVsRest(classifier=rf)
rf_pipeline = Pipeline(stages=[tokenizer, hashingTF, rfr])
rfmodel = rf_pipeline.fit(train_data)
pr = rfmodel.transform(valid_data)
#print("Accuracy of Random Forests is = %g"% (rf_accuracy))

train_data.show(2)

rf_evaluator = get_multiclass_evaluator(pr)

plot_matrix_confusion(pr)
